...
class TestHistory(unittest.TestCase):
    ...
    def test_read_history(self):
        ...
        assert_almost_equal(expected_traj,
                            data.trajectory.cartesian_trajectory)
...
class TestTrajectory(unittest.TestCase):
    ...
    def test_get_config(self):
        ...
        predicted_config = np.array([[1.00, 1.00, 1.00],
                                     [10.00, 10.00, 10.00]])
        assert_almost_equal(expected_config.cartesian_trajectory,
                            predicted_config)
    ...
    def test_get_atom(self):
        ...
        predicted_ca = np.array([[1.0, 1.0, 1.0],
                                 ...
                                 [-4.0, -4.0, -4.0],
                                 [-5.0, -5.0, -5.0]])
        assert_almost_equal(predicted_ca,
                            expected_ca.cartesian_trajectory)
