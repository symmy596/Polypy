...
def test_msd_stats():
    data = np.genfromtxt("polypy/testing/data/MSD.txt", dtype="float")
...
def test_system_volume():
    data = np.genfromtxt("polypy/testing/data/Volume.txt", dtype=float)
...
def test_square_distance():
    data = np.genfromtxt("polypy/testing/data/SD.txt", dtype="float")
